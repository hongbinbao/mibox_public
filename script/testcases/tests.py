...
class Cases(unittest.TestCase):
    ...
    def testLaunchAndExitAppStore(self):
       ...
       """
        ...
        d(resourceId="com.xiaomi.mitv.appstore:id/title_group").child(text='应用商 店').wait.exists(timeout=5000)
        d.press('back')
    ...
    def testLaunchAndExitGameCenter(self):
       ...
       """
        ...
        assert d(text="热门精选").wait.exists(timeout=10000), 'open Game Center failed!'
        d.press('home') 
    ...
    def testLaunchAndExitSetting(self):
       ...
       """
        ...
        assert d(text="帐户与安全").wait.exists(timeout=5000), 'open setting failed!'
        assert d(text="图像与声音").wait.exists(timeout=5000), 'open setting failed!'
        assert d(text="关于").wait.exists(timeout=5000), 'open setting failed!'
        d.press('back') 
        assert d(text="小米盒子设置").wait.exists(timeout=10000), 'exit from Setting failed!'
    ...
    def testLaunchAndExitMediaExplorer(self):
        ...
        assert d(text="视频").wait.exists(timeout=5000), 'open Media Explorer failed!'
        assert d(text="图片").wait.exists(timeout=5000), 'open lMedia Explorer failed!'
        assert d(text="音乐").wait.exists(timeout=5000), 'open Media Explorer failed!'
        d.press('back')
